...
class XInputJoystick(event.EventDispatcher):
    ...
    def dispatch_events(self):
        ...
        if state.packet_number != self._last_state.packet_number:
            ...
            dico, buttons = self.handle_changed_state(state)
    ...
    def handle_changed_state(self, state):
        ...
        dico = self.dispatch_axis_events(state)
        buttons = self.dispatch_button_events(state)
        return dico, buttons
...
def sample_first_joystick():
    ...
    def on_axis(axis, value):
        ...
        right_speed = 0
        #=======================================================================
        # but,pre = on_button(button, pressed)
        # if pre == 1:
        #=======================================================================
